    ...
    do {
        ...
        switch (opcion) {
            case 1:
                ...
                fprintf(archivo,"La cantidd de IVA que se paso es de %.2f\n", iva);
                fprintf(archivo,"La cantidd sin IVA que se paso es de %.2f\n", total);
                fclose(archivo); 

                printf("La cantidd de IVA que se pago es de %.2f\n", iva);
                printf("La cantidd sin IVA que se pago es de %.2f\n", total);
                break;
